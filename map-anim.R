...
anim_save(filename = here("sample-output", paste0("anim-test-", movie_date, ".mp4")), animation=pl, renderer=av_renderer(), nframes=length(unique(data$date)), fps=2/3, detail=2, width=1920, height=1080)
